var test = require('tape')
    ...
    , AerospikeLevelDOWN = require('./').AerospikeLevelDOWN
...
test('test core extensibility', function(t) {
    function Test(location) {
        AerospikeLevelDOWN.call(this, location)
        t.equal(this.location, location, 'location set on `this`')
        t.end()
    }

    util.inherits(Test, AerospikeLevelDOWN)
...
test('test open() extensibility', function(t) {
    var spy = sinon.spy()
        ...
        , expectedOptions = {address: '127.0.0.1', port: 3000}
        , test
...
test('isLevelDOWN', function(t) {
    ...
    t.ok(isLevelDOWN(new AerospikeLevelDOWN('location')), 'IS a leveldown')
    t.ok(isLevelDOWN({
        open: function() {
        },
        close: function() {
